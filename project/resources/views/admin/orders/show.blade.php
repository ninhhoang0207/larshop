    ...
    <div class="box">
        <div class="box-header">
            <div class="row">
                <div class="col-md-6">
                    <h2>
                        <!-- <a href="{{ route('admin.customers.show', $customer->id) }}">{{ $order->first_name }} {{ $order->last_name }}</a> <br /> -->
                        <a href="#">{{ $order->first_name }} {{ $order->last_name }}</a> <br />
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="#">{{ $order->first_name }} {{ $order->last_name }}</a></td>
