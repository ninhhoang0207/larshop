...
<section class="block-content-policy">
  <div class="container">
    <h1 class="fz-36 font-weight-bold">Terms of Service￼</h1>
    <div class="entry-content">
      <p><strong>OVERVIEW</strong></p>
      <p>Welcome to the&nbsp;<a href="https://solizbag.com/">ours</a>&nbsp;website.</p>
      <p>By visiting our site and/ or purchasing something from us, you engage in our “Service” and
        agree to be bound by the following terms and conditions (“Terms of Service”, “Terms”). These
      ...
      <p>Any new features or tools which are added to the current store shall also be subject to the
        ...
        time on this page.</p>
      <p>We reserve the right to update, change, or replace any part of these Terms of Service by
      ...
      <p>In the event that a dispute is raised, we will offer the first line of support and will
        refund the Buyer if deemed appropriate.</p>
      <p>If you have any problems with your order, you can contact our customer care team using
        our&nbsp;<a href="http://asiup.com/contact">helpdesk</a></p>
      ...
      <p>You agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of the
        Service, use of the Service, or access to the Service or any content, copy, materials
        contact on the website through which the service is provided, without written permission by
        us.</p>
      ...
      <h4 class="wp-block-heading">ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h4>
      ...
      <h4 class="wp-block-heading">MODIFICATIONS TO THE SERVICE AND PRICES</h4>
      ...
      <h4 class="wp-block-heading">PRODUCTS OR SERVICES (if applicable)</h4>
      <p>Certain products or services may be available exclusively online through the website. These
        ...
        according to our&nbsp;<a href="http://asiup.com/return-policy">Return Policy</a></p>
      ...
      <p>We reserve the right, but are not obligated, to limit the sales of our products or Services
        ...
        that we offer. All descriptions of products or product pricing are subject to change at any
        time without notice, at the sole discretion of us. We reserve the right to discontinue any
      ...
      <h4 class="wp-block-heading">ACCURACY OF BILLING AND ACCOUNT INFORMATION</h4>
      ...
      <h4 class="wp-block-heading">OPTIONAL TOOLS</h4>
      ...
      <h4 class="wp-block-heading">USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h4>
      ...
      <p>You agree that your comments will not violate any right of any third-party, including
        ...
        as to the origin of any comments.</p>
      ...
      <h4 class="wp-block-heading">ERRORS, INACCURACIES AND OMISSIONS</h4>
      ...
      <h4 class="wp-block-heading">PROHIBITED USES</h4>
      ...
      <h4 class="wp-block-heading">DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h4>
      ...
      <p>You agree to indemnify, defend and hold harmless theuspants.com and our parent, subsidiaries,
      ...
      <p>In the event that any provision of these Terms of Service is determined to be unlawful, void
        ...
        enforceability of any other remaining provisions. In the event that any provision of these
      ...
      <h4 class="wp-block-heading">ENTIRE AGREEMENT</h4>
      ...
      <p>These Terms of Service and any separate agreements whereby we provide you Services shall be
        governed by Singapore government and construed in accordance with the laws.</p>

      <h4 class="wp-block-heading">CHANGES TO TERMS OF SERVICE</h4>
